...
JS;
    ...
    public static function livemap($url = '/livemap', $skipList = []) {
        ...
        if ($skip === false) {
            $data = [
                'hostPrivateIP' => isset($footprint['hostPrivateIP']) ? $footprint['hostPrivateIP'] : null,
                'hostPublicIP' => isset($footprint['hostPublicIP']) ? $footprint['hostPublicIP'] : null,
                'hostLatitude' => isset($footprint['hostLatitude']) ? $footprint['hostLatitude'] : null,
                'hostLongitude' => isset($footprint['hostLongitude']) ? $footprint['hostLongitude'] : null,
                ...
                'clientPlatform' => isset($footprint['clientPlatform']) ? $footprint['clientPlatform'] : null,
                'clientBrowser' => isset($footprint['clientBrowser']) ? $footprint['clientBrowser'] : null,
                'clientPrivateIP' => isset($footprint['clientPrivateIP']) ? $footprint['clientPrivateIP'] : null,
                'clientPublicIP' => isset($footprint['clientPublicIP']) ? $footprint['clientPublicIP'] : null,
                'clientLat' => isset($footprint['clientLat']) ? $footprint['clientLat'] : null,
                'clientLon' => isset($footprint['clientLon']) ? $footprint['clientLon'] : null,
                'clientCountryCode' => isset($footprint['clientCountryCode']) ? $footprint['clientCountryCode'] : null,
                'clientCountry' => isset($footprint['clientCountry']) ? $footprint['clientCountry'] : null,
                'clientCity' => isset($footprint['clientCity']) ? $footprint['clientCity'] : null,
                'clientArea' => isset($footprint['clientArea']) ? $footprint['clientArea'] : null,
                'clientIsp' => isset($footprint['clientIsp']) ? $footprint['clientIsp'] : null,
                'clientVpn' => isset($footprint['clientVpn']) ? $footprint['clientVpn'] : null,
                'requestMETHOD' => isset($footprint['REQUEST_METHOD']) ? $footprint['REQUEST_METHOD'] : null,
                'requestURL' => isset($footprint['REQUEST_URI']) ? $footprint['REQUEST_URI'] : null,
                'clientDeviceId' => isset($footprint['clientDeviceId']) ? $footprint['clientDeviceId'] : null,
                'clientFingerprintId' => isset($footprint['clientFingerprintId']) ? $footprint['clientFingerprintId'] : null,
                'clientFingerprint' => isset($footprint['clientFingerprint']) ? $footprint['clientFingerprint'] : null,
                'netkey' => isset($footprint['netkey']) ? $footprint['netkey'] : null,
                'devicekey' => isset($footprint['devicekey']) ? $footprint['devicekey'] : null,
                'requestTime' => isset($footprint['REQUEST_TIME']) ? $footprint['REQUEST_TIME'] : null,
                'requestFLOAT' => isset($footprint['REQUEST_TIME_FLOAT']) ? $footprint['REQUEST_TIME_FLOAT'] : null,
                'datetime' => isset($footprint['REQUEST_TIME_FLOAT']) ? date("Y-m-d H:i:s", (int)$footprint['REQUEST_TIME_FLOAT']) : null
            ];
